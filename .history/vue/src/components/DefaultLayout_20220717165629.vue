                ...
                <div class="h-full flex items-center">
                    ...
                    <ul class="pr-12 xl:flex items-center h-full hidden">
                        <li class="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm  tracking-normal">
                         ...
                         <li class="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm  tracking-normal">
                         <router-link :to="{name: '/Dashboard'}" > Survey </router-link> 
                        </li>
                        <!-- <li class="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-gry-800 mx-10 tracking-normal">
                         <router-link 
                            ...
                            :class="[ this.$route.name === item.to.name ? '' : ' hover:bg-gray-700 hover:text-white', 'px-3 py-2 rounded-md text-sm font-medium']"> 
                            {{item.name}}
                        </router-link> 
                        </li> -->
