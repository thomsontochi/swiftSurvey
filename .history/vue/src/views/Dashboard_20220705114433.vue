    ...
    <body style="height: 600px">
        <div class="dark:bg-gray-900">
            <div>
                <div class="relative">
                    <!-- For md screen size -->
                    <div v-if="search" id="md-searchbar" class="bg-white w-full dark:bg-gray-900 lg:hidden py-5 px-6 items-center justify-between">
                    ...
                    <div class="dark:bg-gray-900 bg-gray-50 px-6 py-9">
                        <div class="container mx-auto flex items-center justify-between">
                            ...
                            <ul class="hidden w-8/12 md:flex items-center justify-center space-x-8">
                                <li>
                                    <a href="javascript:void(0)" class="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Homes</a>
                                </li>
                                <li>
                    ...
                    <!-- For small screen -->
                    <div id="mobile-menu" v-if="menu" class="absolute dark:bg-gray-900 z-10 inset-0 md:hidden bg-white flex flex-col h-screen w-full">
                        <div class="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-4 p-4">
                            ...
                            <button @click="menu=false" aria-label="close menu" class="focus:outline-none focus:ring-2 rounded focus:ring-gray-600">
